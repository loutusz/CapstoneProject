    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <div className="flex">
            <a className="flex item-center text-white bg-customdarkerBlue border-0 py-2 px-6 focus:outline-none hover:bg-custombluegray rounded" href="/registerPage" role="button">Get Started</a>
          </div>
        </div>
